...
function QuizEditor({ quiz, onCancel, onSave }) {
  ...
  return <section className="hl-teacher-quiz-editor">
    ...
    <div className="hl-teacher-title"><div><h1>{quiz ? 'Sửa bài kiểm tra' : 'Tạo bài kiểm tra'}</h1><p>Câu hỏi và quy định làm bài.</p></div></div>
