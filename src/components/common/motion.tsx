...
export function Reveal({ children, delay = 0, style, ...rest }: RevealProps) {
...
export function Counter({ to, suffix = '', style }: CounterProps) {
...
export function ImageSlot({ src, alt = '', circle = false, radius = 0, style }: ImageSlotProps) {
  return (
    <img
      src={src}
      alt={alt}
