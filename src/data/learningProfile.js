export const learningProfilePage = {
  ...
  practiceAttempts: [
    { label: '#1', type: 'Thi thử', score: 610, components: { vietnamese: 185, english: 142, math: 158, science: 125 } },
    { label: '#2', type: 'Thi thử', score: 655, components: { vietnamese: 194, english: 150, math: 170, science: 141 } },
    { label: '#3', type: 'Mini Test', score: 702, components: { vietnamese: 205, english: 160, math: 181, science: 156 } },
    { label: '#4', type: 'Thi thử', score: 680, components: { vietnamese: 198, english: 154, math: 178, science: 150 } },
    { label: '#5', type: 'Mini Test', score: 742, components: { vietnamese: 218, english: 174, math: 186, science: 164 } },
    { label: '#6', type: 'Thi thử', score: 790, components: { vietnamese: 226, english: 188, math: 202, science: 174 } },
  ],
  ...
  practiceAiAnalysis: {
    ...
    summary: 'Các bài luyện đề gần đây cho thấy nhóm tư duy khoa học và bài toán xác suất cần được ưu tiên vì độ chính xác còn dao động khi gặp dữ liệu dài.',
    recommendations: [
      {
        title: 'Logic & phân tích số liệu',
        accuracy: 52,
        priority: 'Cao',
        action: 'Luyện ngay',
        explanation: 'Tập trung đọc bảng số liệu, nhận diện quy luật và loại trừ phương án nhiễu trước khi tính toán chi tiết.',
      },
      {
        title: 'Suy luận khoa học',
        accuracy: 57,
        priority: 'Cao',
        action: 'Luyện ngay',
        explanation: 'Nên luyện các câu yêu cầu giải thích thí nghiệm, giả thuyết và kết luận từ dữ kiện cho sẵn.',
      },
      {
        title: 'Toán - Xác suất',
        accuracy: 61,
        priority: 'Trung bình',
        action: 'Luyện ngay',
        explanation: 'Ôn lại quy tắc đếm, biến cố độc lập và cách chuyển đề bài thành sơ đồ trường hợp.',
      },
      {
        ...
        priority: 'Trung bình',
        action: 'Luyện ngay',
        explanation: 'Rèn chiến thuật bỏ qua câu dài, quay lại sau và giữ nhịp làm bài ổn định trong 30 phút cuối.',
      },
    ],
    history: [
      {
  ...
  teacherFeedback: [
    {
      ...
      comment: 'Em nên ưu tiên ôn lại Xác suất và dành thêm thời gian cho nhóm câu Logic & phân tích số liệu trong tuần này.',
    },
    {
      id: 'feedback-02',
      teacher: {
      ...
      comment: 'Khả năng đọc hiểu của em đang tiến bộ, nhưng cần luyện thêm câu hỏi suy luận ngữ cảnh và giữ tốc độ ổn định ở phần văn bản dài.',
    },
  ],
  aiAnalysisHistory: [
    {
      ...
      createdAt: '10/09/2026',
      basedOn: '5 bài thi gần nhất',
      summary: 'Điểm số đang tăng đều qua các bài thi thử. Bạn giữ nhịp tốt ở Tiếng Việt và Toán học, nhưng cần củng cố nhóm câu suy luận khoa học để tiến gần mục tiêu 900.',
      strengths: ['Đọc hiểu Tiếng Việt', 'Ngữ pháp Tiếng Anh', 'Hàm số'],
      improvements: ['Logic & phân tích số liệu', 'Suy luận khoa học', 'Toán - Xác suất'],
    },
    {
      ...
      summary: 'Năng lực nền tảng ổn định, tốc độ làm bài đã cải thiện. Nên dành thêm thời gian cho bài toán xác suất và câu hỏi phân tích dữ kiện.',
    ...
    },
    {
      ...
      summary: 'Bạn đã xây được thói quen luyện đề đều đặn. Nhóm câu Tiếng Việt có độ chính xác tốt, trong khi Tư duy khoa học cần luyện chậm và chắc hơn.',
