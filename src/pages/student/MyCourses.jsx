...
import { studentCourses, studentCourseSubjects, studentCourseTypes } from '../../data/studentCourses'
...
function MyCourses({ onOpenCourse }) {
  ...
  const activeTypeLabel = studentCourseTypes.find((type) => type.key === activeType)?.label || 'Khóa học'
